...
<head>
	...
	<title>PlanD 3D GIS Function Lists UAT - Test EricY </title>
...
%>
<H2 align="center"><u> PlanD 3D GIS UAT at 28-Feb-2017 (Version: <%=APP_VER %>)</u></H2>
...
%>
		...
		<input type="button" value="Update comment" onclick="update(<%= rs.getString("RID") %>);"></input>
		</td>
		</tr>
<%
	}
