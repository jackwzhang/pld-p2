...
<%
	...
	datasourceconnection.setDatabase("SQLServerSource");
	...
	DatasetVector dataset = (DatasetVector) datasource.getDatasets().get("Proposed_Site");
	...
	if(!editType.equals("DELETE"))
	{
		...
		else if(editType.equals("UPDATE"))		// Update a selected feature
		{
			...
			for(int i=0; i<fNames.length; i++)
			{
				...
				else if(fNames[i].equals("BASEHEIGHT"))
